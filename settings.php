                                    ...
                                    <form class="row" method="POST" action="sdf.php" id="update_form" onsubmit="validate()">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="">
                                                ...
                                                <input id="changeColorDemo" onkeyup="changeTheColorOfButtonDemo()" type="email" class="form-control form-control-lg border-0 placeholder-sora" name="n_email" id="n_email" placeholder="Current Password" required>
                                            </div>
                                            <div class="mt-4">
                                        ...
                                        <div class="col-md-6 mt-4 mt-md-0 col-12">
                                            <div class="">
                                                ...
                                                <input type="password" class="form-control form-control-lg border-0 placeholder-sora" name="n_password" id="n_password" placeholder="Enter new password" required>
                                            </div>
                                            <div class="mt-4">

                                                <input type="password" class="form-control form-control-lg border-0 placeholder-sora" name="c_password" id="c_password" placeholder="Confirm new password" required>
                                ...
                                <div class="modal-body p-60">
                                    <form class="row" method="POST" action="settings.php">
                                        <div class="col-12 mt-2  mb-50 text-center">
                                            ...
                                            if ($action == 'error') {
                                                echo '<p id="action_error" class="mt-3" style="color:#D89459;">Password Does not matched</p>';
                                            }
                                        ...
                                        <div class="col-12 mt-50 mb-4">
                                            <div class="row mt-3">
                                                <div class="col">
                                                    <button type="submit" id="buttonDemo" name="check_credentials" style="font-family:Sora-SemiBold;border-radius:35px;background-color:#f5f5f5; color:white;" class="btn col-12 btn btn-lg p-4 pe-md-5 ps-md-5 ">Update
                                                    </button>
                                                </div>
