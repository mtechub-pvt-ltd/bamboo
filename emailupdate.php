...
<body class="layout-1">
    ...
    <div class="wrapper" style="background-color:#F5F5F5;">
        ...
        <div class="page-body px-xl-4 px-sm-2 px-0 py-lg-2  mt-3 mt-lg-5">
                            ...
                            <div class="modal-content modal-dialog modal-dialog-centered modal-md" style="margin-top:20px;background-color:#fff; border-radius:80px;">
                                ...
                                <div class="modal-body p-60">
                                    <form class="row" method="POST" action="settings.php">
                                        <div class="col-12 mt-2  mb-50 text-center">
                                            <img style="width:30px; height:30px;" src="assets/img/logoimage.png"></a>
                                            <h3 class="mt-2 ">Update ID</h3>
                                            <?php if ($action == 'error') {
                                                echo '<p id="action_error" class="mt-3"style="color:#D89459;">Email or Password is Wrong</p>';
                                            }
                                            ?>
                                            <p id="password_error" class="mt-3 text-danger2">ID is not correct</p>
                                            <?php
                                        ...
                                        <div class="col-12">
                                            <div class="">
                                                ...
                                                <input type="text" id="changeColorDemo" onkeyup="changeTheColorOfButtonDemo()" class=" form-control form-control-lg  placeholder-sora" style="border-radius:35px;" name="email" placeholder="Current ID" required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mt-4">

                                                <input id="changeColorDemo1" onkeyup="changeTheColorOfButtonDemo()" class="mandatoryfields form-control form-control-lg  placeholder-sora" style="border-radius:35px;  " type="password" name="password" placeholder="New ID" required>
                                                <?php
                                        ...
                                        <div class="col-12">
                                            <div class="mt-4">
                                                ...
                                                <input id="changeColorDemo2" onkeyup="changeTheColorOfButtonDemo()" class="mandatoryfields form-control form-control-lg  placeholder-sora" style="border-radius:35px; " type="password" name="password" placeholder="Confirm new ID" required>
                                                <?php
                                        ...
                                        <div class="col-12 mt-50 mb-4">
                                            <div class="row mt-3">
                                                <div class="col">
                                                    <button type="submit" id="buttonDemo" name="check_credentials" style="font-family:Sora-SemiBold;border-radius:35px;background-color:#BDBDBD; color:white;" class="btn col-12 btn btn-lg  pe-md-5 ps-md-5 ">Update
                                                    </button>
                                                </div>
    ...
    <script>
        ...
        function changeTheColorOfButtonDemo() {
            if (document.getElementById("changeColorDemo").value !== "" && document.getElementById("changeColorDemo1").value !== "" && document.getElementById("changeColorDemo2").value !== "") {
                ...
                document.getElementById("buttonDemo").style.background = "#F5F5F7";
